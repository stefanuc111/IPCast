...
public class DynamicListView extends ListView {
    ...
    public ArrayList<PlayListElement> mPlaylist;
    ...
    private void handleCellSwitch() {
        ...
        if (isBelow || isAbove) {
            ...
            swapElements(mPlaylist, originalItem, getPositionForView(switchView));
	...
	private void touchEventsEnded () {
        ...
        if (mCellIsMobile|| mIsWaitingForScrollFinish) {
            ...
            if(Build.VERSION.SDK_INT>=11)
            {
                 ...
                 */
                final TypeEvaluator<Rect> sBoundEvaluator = new TypeEvaluator<Rect>() {
    ...
    public void setPlaylist(ArrayList<PlayListElement> playlist) {
        mPlaylist = playlist;
    }
